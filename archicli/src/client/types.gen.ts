...
export type AddConnectionToViewOp = {
    ...
    /**
     * Source visual object ID (from addToView result or existing visual)
     */
    sourceVisualId: string;
    /**
     * Target visual object ID (from addToView result or existing visual)
     */
...
export type PostModelSaveData = {
    body?: {
         ...
         * Required when the model has never been saved before.
...
export type PostModelSaveErrors = {
    /**
     * Path required (model has never been saved)
     */
    400: ErrorResponse;
    /**
     * Save failed
